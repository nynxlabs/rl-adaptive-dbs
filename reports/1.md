...
I built this from the paper text and figures (no released training or environment source). The shared dynamics use the **Kumaravelu et al. (2016)** cortex-basal ganglia-thalamus model. Full run commands, manifests, and internal gates live in [figures/mehregan/replications.md](https://github.com/nynxlabs/rl-adaptive-dbs/blob/main/figures/mehregan/replications.md).
...
4. **Validation.** Qualitative gates (ordering, onset timing, training shape) documented in [figures/mehregan/replications.md](https://github.com/nynxlabs/rl-adaptive-dbs/blob/main/figures/mehregan/replications.md) and [replication-fidelity.md](https://github.com/nynxlabs/rl-adaptive-dbs/blob/main/docs/development/replication-fidelity.md).
